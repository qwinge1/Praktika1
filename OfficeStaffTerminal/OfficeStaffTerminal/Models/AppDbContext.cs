...
namespace OfficeStaffTerminal.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BlacklistEntry>().ToTable("ЧёрныйСписок");

            // Связь Application -> PersonalVisitor (один к одному)
            ...
            // Связь Document -> PersonalVisitor
            modelBuilder.Entity<Document>()
            ...
            // Связь Application -> GroupVisitors
            modelBuilder.Entity<Application>()

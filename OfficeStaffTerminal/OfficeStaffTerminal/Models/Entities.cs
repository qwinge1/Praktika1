...
namespace OfficeStaffTerminal.Models
{
    ...
    public class BlacklistEntry
    {
        ...
        [Column("тип_посетителя")]
        public string VisitorType { get; set; } = null!; // "личный" или "групповой"

        [Column("посетитель_личный_id")]
        public int? PersonalVisitorId { get; set; }

        [Column("посетитель_групповой_id")]
        public int? GroupVisitorId { get; set; }

        [Column("причина")]
        public string Reason { get; set; } = null!;

        [Column("дата_добавления")]
